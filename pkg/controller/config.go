...
func ParseFlags() (*Configuration, error) {
	...
	if config.NeedVlan() && config.DefaultHostInterface == "" {
...
func (config *Configuration) NeedVlan() bool {
	return config.NetworkType == util.NetworkTypeHybrid || config.NetworkType == util.NetworkTypeVlan
}
